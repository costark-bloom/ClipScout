      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
        ...
        <div className="text-center mb-12 space-y-4 animate-fade-in">
          <div className="flex flex-col items-center gap-4 mb-2">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-950/50">
              <svg
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
            {[
              ...
              <span
                key={pill.label}
                className="inline-flex items-center gap-1.5 text-xs bg-gray-900 border border-gray-800 text-gray-400 px-3 py-1.5 rounded-full"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  'Claude identifies every phrase that would benefit from B-roll and generates optimized search queries.',
                icon: (
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
